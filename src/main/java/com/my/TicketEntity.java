...
@Entity
@Table(name = "ticket", schema = "lab_5abc", catalog = "")
public class TicketEntity {
    ...
    @ManyToMany
    @JoinTable(name = "ticket_coach", catalog = "", schema = "lab_5abc", joinColumns = @JoinColumn(name = "ticket_id", referencedColumnName = "id_ticket", nullable = false), inverseJoinColumns = @JoinColumn(name = "coach_id", referencedColumnName = "id_coach", nullable = false))
